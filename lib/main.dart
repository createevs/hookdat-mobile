...
import 'package:hook_dat/login_page/login_page_widget.dart';
import 'flutter_flow/flutter_flow_theme.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Stream<HookDatFirebaseUser> userStream;
  HookDatFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = hookDatFirebaseUserStream()
