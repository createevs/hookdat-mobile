    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'street_address':
          ...
          break;
        case 'apt_suite_etc':
          result.aptSuiteEtc = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
        case 'city':
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  String _aptSuiteEtc;
  String get aptSuiteEtc => _$this._aptSuiteEtc;
  set aptSuiteEtc(String aptSuiteEtc) => _$this._aptSuiteEtc = aptSuiteEtc;
